...
public class HttpsUtil {
    ...
    /**
     * @param context        上下文
     * @param certificates "XXX.cer" 文件 (文件位置assets/XXX.cer)
     * @param bksFiled      "XXX.bks"文件(文件位置assets/XXX.bks)
     * @param password       The certificate's password.
     * @return SSLParams
     */
    public static SSLParams getSslSocketFactory(Context context, InputStream[] certificates, InputStream bksFiled, String password) {
        if (context == null) {
        ...
        try {
            ...
            KeyManager[] keyManagers = prepareKeyManager(bksFiled, password);
    ...
    private static TrustManager[] prepareTrustManager(InputStream... certificates) {
        ...
        try {
            ...
            for (InputStream certificate : certificates) {
                ...
                //证书工厂根据证书文件的流生成证书Certificate //将证书certificate作为信任的证书放入到keyStore中
